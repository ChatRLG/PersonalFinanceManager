...
///
/// Android note: the 60-second background poll (see BackgroundSyncService) can be
/// suspended by Doze/battery-optimization while the app is backgrounded. SyncAsync is
/// therefore also invoked in the foreground — from page OnAppearing() and a manual
/// pull-to-refresh on the Transactions list — so reconciliation doesn't depend solely
/// on the background timer. A WorkManager-backed reliable scheduler is deferred to
/// Phase 6b.
/// </summary>
