...
namespace PersonalFinanceManager.Mobile.Tests;

/// <summary>
/// Unit tests for SyncService. All external dependencies are mocked; no
/// Android/MAUI-specific APIs are used, so this project targets plain net9.0
/// (see PersonalFinanceManager.Mobile.Tests.csproj and docs/ROADMAP.md Phase 6a).
/// Mirrors PersonalFinanceManager.Desktop.Tests/SyncServiceTests.cs exactly.
/// </summary>
